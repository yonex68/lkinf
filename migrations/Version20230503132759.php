 ...
 */
final class Version20230503132759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE disponibilite (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, jour VARCHAR(255) NOT NULL, heure_ouverture TIME NOT NULL, heure_cloture TIME NOT NULL, ordre SMALLINT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_2CBACE2FED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE emplois_temps (id INT AUTO_INCREMENT NOT NULL, vendeur_id INT DEFAULT NULL, jour VARCHAR(255) NOT NULL, heure_ouverture TIME NOT NULL, heure_cloture TIME NOT NULL, ordre SMALLINT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_551C3168858C065E (vendeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
